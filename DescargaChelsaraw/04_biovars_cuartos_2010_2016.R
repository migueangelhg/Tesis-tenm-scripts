...
gc()
library(magrittr)
prc_path <- list.files("~/Documentos/chelsa/prec_avg_2010_2016",
...
prc_cuartos_ids <- rio::import("prc_cuartos_ids_2010_2016.rds")
...
bio8[] <- bio8_v
raster::plot(bio8)
raster::writeRaster(bio8,"bios_2010_2016/bio_08.tif",overwrite=TRUE)
...
bio9[] <- bio9_v
raster::plot(bio9)
raster::writeRaster(bio9,"bios_2010_2016/bio_09.tif",overwrite=TRUE)
rm(list = c("bio9","bio9_vals","bio9_v","prc_cuartos_ids"))
gc()

tmp_cuartos_ids  <- rio::import("tmp_cuartos_ids_2010_2016.rds")
...
gc()
raster::plot(bio18)
raster::writeRaster(bio18,"bios_2010_2016/bio_18.tif",overwrite=TRUE)
gc()
...
gc()
raster::plot(bio19)
raster::writeRaster(bio19,"bios_2010_2016/bio_19.tif",overwrite=TRUE)
rm(list=ls())
gc()
