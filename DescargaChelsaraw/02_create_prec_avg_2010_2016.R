...
rm(list = ls())
gc()
prec_paths <- list.files("~/Documentos/chelsa/prec_2010_2016",pattern = ".tif$",
                         full.names = TRUE)
prec_2010_2016 <- grep("_20[1-2][0-9]_V.1.0.tif",prec_paths)

prec_paths_n <- prec_paths[prec_2010_2016]
# nNA value -32768
...
x=1
if(!dir.exists("prec_avg_2010_2016")) dir.create("prec_avg_2010_2016")
months <- c(paste0("0",1:9),10:12)
filenames <- paste0("prec_",months,".tif")
filepaths <- file.path("prec_avg_2010_2016",filenames)
