...
tmax_paths <- list.files("~/Documentos/chelsa/tmax_1920_1980",pattern = ".tif$",
                         full.names = TRUE)
tmax_20_79 <- grep("_19[2-7][0-9]_V.1.0.tif",tmax_paths)
tmax_80 <- grep("_1980_V.1.0.tif",tmax_paths)

tmax_ids <- c(tmax_20_79,tmax_80)

tmax_paths_n <- tmax_paths[tmax_ids]
# nNA value -32768
...
x=1
if(!dir.exists("tmax_avg_1920_1980")) dir.create("tmax_avg_1920_1980")
months <- c(paste0("0",1:9),10:12)
filenames <- paste0("tmax_",months,".tif")
filepaths <- file.path("tmax_avg_1920_1980",filenames)
