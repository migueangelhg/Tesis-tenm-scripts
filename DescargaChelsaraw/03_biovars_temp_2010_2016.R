...
# Uses the tmin and tmax averages from 2010 to 2016
...
library(magrittr)
gc()
tmn_path <- list.files("~/Documentos/chelsa/tmin_avg_2010_2016",
                       full.names = T,pattern = ".tif$")

tmx_path <- list.files("~/Documentos/chelsa/tmax_avg_2010_2016",
                       full.names = T,pattern = ".tif$")
...
gc()
if(!dir.exists("bios_2010_2016"))dir.create("bios_2010_2016")
...
bio_1[] <- bio_1_vals 
raster::plot(bio_1)
raster::writeRaster(bio_1,"bios_2010_2016/bio_01.tif",overwrite=TRUE)
...
bio_4[] <- bio_4_vals 
raster::plot(bio_4)
raster::writeRaster(bio_4,"bios_2010_2016/bio_04.tif",overwrite=TRUE)
...
dim(tmp_cuartos_id )
rio::export(tmp_cuartos_id,"tmp_cuartos_ids_2010_2016.rds")
...
bio10[] <- bio10_v
raster::plot(bio10)
raster::writeRaster(bio10,"bios_2010_2016/bio_10.tif",overwrite=TRUE)
...
bio11[] <- bio11_v
raster::plot(bio11)
raster::writeRaster(bio11,"bios_2010_2016/bio_11.tif",overwrite=TRUE)
...
bio_2[] <- bio_2_vals 
raster::plot(bio_2)
raster::writeRaster(bio_2,"bios_2010_2016/bio_02.tif",overwrite=TRUE)
...
bio_5[] <- bio_5_vals 
raster::plot(bio_5)
raster::writeRaster(bio_5,"bios_2010_2016/bio_05.tif",overwrite=TRUE)
...
bio_6[] <- bio_6_vals 
raster::plot(bio_6)
raster::writeRaster(bio_6,"bios_2010_2016/bio_06.tif",overwrite=TRUE)
rm(list = c("bio_6","bio_6_vals","bio_6_mat","t_min"))
gc()
# BIO7. Temperature Annual Range (P5-P6) 

bio5 <- raster::raster("bios_2010_2016/bio_05.tif")
bio5_vals <- bio5[]
bio5_vals <- bio5_vals[nona_cells]
bio6 <- raster::raster("bios_2010_2016/bio_06.tif")
bio6_vals <- bio6[]
...
bio7[] <- bio7_all
raster::plot(bio7)
raster::writeRaster(bio7,"bios_2010_2016/bio_07.tif",overwrite=TRUE)
rm(list = ls())
gc()

# BIO3. Isothermality (100 * BIO2 / BIO7) 
bio2 <- raster::raster("bios_2010_2016/bio_02.tif")
bio7 <- raster::raster("bios_2010_2016/bio_07.tif")
nona_cells <- rio::import("nona_ids_2010_2016.rds")
bio2_v <- bio2[]
...
bio3[] <- bio3_v
raster::plot(bio3)
raster::writeRaster(bio3,"bios_2010_2016/bio_03.tif",overwrite=TRUE)
rm(list = ls())
gc()